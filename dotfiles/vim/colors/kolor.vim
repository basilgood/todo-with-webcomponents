...
highlight Normal          guifg=#c6c6c6    guibg=#1B1D1E    gui=none
highlight SpecialKey      guifg=#465457    guibg=NONE       gui=none
highlight NonText         guifg=#465457    guibg=NONE       gui=none
...
highlight StatusLine ctermfg=253 ctermbg=24 guifg=#d9d9d9 guibg=#304a68 guisp=NONE cterm=NONE gui=NONE
highlight StatusLineNC ctermfg=248 ctermbg=236 guifg=#a0a4aa guibg=#30343c guisp=NONE cterm=NONE gui=NONE
...
if g:kolor_bold==0
  ...
  if g:kolor_alternative_matchparen==0 && g:kolor_inverted_matchparen==0
    highlight MatchParen      guifg=#ff0087    guibg=NONE     gui=none
  ...
  if g:kolor_alternative_matchparen==0 && g:kolor_inverted_matchparen==0
    highlight MatchParen      guifg=#ff0087    guibg=NONE     gui=bold
  elseif g:kolor_inverted_matchparen==0
    highlight MatchParen      guifg=#ff0087    guibg=NONE     gui=bold
  else
    highlight MatchParen      guifg=#ff0087     guibg=NONE    gui=bold
...
if &t_Co > 255
  ...
  highlight StatusLine      ctermfg=235     ctermbg=101     cterm=none
  highlight StatusLineNC    ctermfg=101     ctermbg=238     cterm=none
